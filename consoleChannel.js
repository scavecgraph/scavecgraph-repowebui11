...
function doDirection(config){
    ...
    console.log("*** PORTAL CHANNEL URL : " + url);
...
function saniizeUrl(urlString){
    ...
    let params = "showTracker=" + pshowTracker + "&trackerScale=" + ptrackerScale + "&color=" + pcolor + "&navColor=" + pnavColor + "&glass" + pglass + "&contextId=" + pcontextId;
    return params;
}
